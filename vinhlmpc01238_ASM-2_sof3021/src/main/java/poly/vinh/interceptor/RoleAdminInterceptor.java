...
public class RoleAdminInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
		...
		if (null == account || !account.getAdmin()) {
	...
	@RequestMapping("/signin-er-ad")
	String gogo(HttpServletRequest request, RedirectAttributes redirectAttribute) {
		redirectAttribute.addFlashAttribute("error", "Vui lòng đăng nhập tài khoản Administrator để tiếp tục sử dụng");
